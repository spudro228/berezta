/*
 * This is an implementation of wcwidth() and wcswidth() (defined in IEEE Std
 * 1002.1-2001) for Unicode.
 *
 ...
 * occupy two such cells. Markus Kuhn's original implementation.
 *
 * Latest version: https://www.cl.cam.ac.uk/~mgk25/ucs/wcwidth.c
 * Updated with Unicode 15.0 ranges.
 */
...
/* Combining characters (Unicode 15.0) */
static const struct interval combining[] = {
    ...
    { 0x0890, 0x0891 }, { 0x0898, 0x089F }, { 0x08CA, 0x08E1 },
    ...
    { 0x11F40, 0x11F40 }, { 0x11F42, 0x11F42 }, { 0x13430, 0x1345F },
...
/* Wide characters (East Asian Wide/Fullwidth, Unicode 15.0) */
static const struct interval wide[] = {
    ...
    { 0x2B55, 0x2B55 }, { 0x3000, 0x3000 }, { 0x3004, 0x3004 },
    { 0x3008, 0x3008 }, { 0x3012, 0x3012 }, { 0x3014, 0x3014 },
    { 0x3020, 0x3020 }, { 0x3030, 0x3030 }, { 0x303D, 0x303D },
    { 0x3297, 0x3297 }, { 0x3299, 0x3299 }, { 0x3001, 0x303E },
